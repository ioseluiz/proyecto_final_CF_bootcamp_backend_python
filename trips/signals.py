...
def create_bus_seats(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        print(
            "Bus creado exitosamente...por lo tanto se crean los asientos correspondientes..."
        )
    else:
        print("Bus updated")
...
def create_tickets(sender, instance, created, **kwargs):
    if created:
        ...
        SeatTrip.objects.bulk_create(
            [SeatTrip(seat=seat, trip=instance) for seat in seats]
        )
